...
<sub>왼쪽 — **1층 → 엘리베이터 자율 탑승 → 5층 504호** 전 구간 (1회) &nbsp;·&nbsp; 오른쪽 — **음성 목적지 변경 · 손잡이 조작** (2공학관 촬영 · ITRC 인재양성대전(코엑스) 상영)</sub>
...
<div align="center">
<img src="docs/images/handle-hardware.png" width="260"/>
</div>
...
**결함 160건**을 두 규칙으로 기록한다. **확증과 정황을 섞지 않는다**,
**증상을 사용자 관점으로 쓴다.** 
...
| [결함 카탈로그 (FINDINGS)](.claude/FINDINGS.md) | 160건 · 확증/정황 구분 |
